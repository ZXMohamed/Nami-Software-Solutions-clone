...
export default function Contactbtns() {
  return (
    <Stack className='contactbtns'>
        <a href="https://Wa.me/+020100000000000" target='_blank'>
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 176 176" xmlSpace="preserve">
                <g>
                    <g data-name="Layer 2">
                        <g data-name="09.whatsapp">
                            <circle cx="88" cy="88" r="88" fill="#29A71A" opacity="1" data-original="#29a71a"></circle>
                            <g fill="#FFFFFF">
        ...
        <a href="tel:+020100000000000" target='_blank'>
