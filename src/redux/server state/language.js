            ...
            async onQueryStarted(arg, { dispatch, queryFulfilled }) {
                try {
                    await queryFulfilled.then(() => {
                        ...
                        dispatch(
                            servicesSlice.util.invalidateTags(['ReQueryForMainPage'])
                        );
                    });
                } catch (error) {
...
// languageSlice.injectEndpoints({
//     endpoints: (builder) => ({
//         getServices: builder.query({
//             queryFn: () => { console.log("sda"); return servicesSlice.endpoints.getServices.initiate(); },
//             providesTags:['ReCallWithNewLanguage']
//         }),
//     })
// })
